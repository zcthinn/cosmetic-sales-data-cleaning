...
| File | Description |
|---|---|
| `messy_cosmetic_sales_data.xlsx` | Original raw dataset (before cleaning) |
| `cleaned_cosmetic_sales_data.xlsx` | Final cleaned dataset (after cleaning) |
| `cleaning_writeup.md` | Full step-by-step documentation of the cleaning process |
